-- Database Creation Script for the Online Store Database
...
INSERT INTO
  product_group (product_group_number, product_group_name)
VALUES
  (1, 'Pastries'),
  (2, 'Drinks');
...
VALUES
  ...
  (
    ...
    3.50,
    1,
    'images/Strawberry-Blueberry-Tarts.jpg'
  ),
  (
    'Strawberry Tart',
    ...
    3.50,
    1,
    'images/Strawberry-Tarts.jpg'
  ),
  (
    'Coffee',
    'Freshly-ground black or blended Columbian coffee',
    3.00,
    2,
    'images/Coffee.jpg'
  ),
  (
    'Hot Chocolate',
    'Rich and creamy, and made with real chocolate',
    3.00,
    2,
    'images/Cup-of-Hot-Chocolate.jpg'
  ),
  (
    'Latte',
    'Offered hot or cold and in various delicious flavors',
    3.50,
    2,
    'images/Latte.jpg'
  );
